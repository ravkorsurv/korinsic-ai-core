...
class InsiderDealingConfig:
    ...
    def get_config_summary(self) -> str:
        ...
        summary += f"  Risk Thresholds: Low={self.config['risk_thresholds']['low_risk']}, "
        summary += f"Medium={self.config['risk_thresholds']['medium_risk']}, "
        summary += f"High={self.config['risk_thresholds']['high_risk']}\n"
        summary += f"  Latent Intent: {self.config['model_parameters']['use_latent_intent']}\n"
        ...
        summary += f"  Evidence Weights: {len(self.config['evidence_weights'])} configured\n"
