...
class WashTradeDetectionConfig:
    ...
    def _merge_configs(self):
        ...
        def merge_dict(default: Dict[str, Any], provided: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def get_detection_thresholds(self) -> Dict[str, float]:
        ...
        """
        return {
            'wash_trade_probability_threshold': self.get('wash_trade_probability_threshold'),
    ...
    def validate_configuration(self) -> bool:
        ...
        try:
            ...
            required_fields = [
                'model_name', 'model_version', 'wash_trade_probability_threshold',
                'signal_distortion_threshold', 'algo_reaction_threshold'
            ]
