...
class CommodityManipulationModel:
    ...
    def __init__(self, use_latent_intent: bool = True, config: Optional[Dict[str, Any]] = None):
        ...
        logger.info(f"Commodity manipulation model initialized (latent_intent={use_latent_intent})")
    ...
    def _build_standard_model(self) -> DiscreteBayesianNetwork:
        ...
        nodes = [
            ...
            'risk_factor', 'commodity_manipulation'
        ]
    ...
    def _add_cpds(self, model: DiscreteBayesianNetwork, use_latent_intent: bool = False):
        ...
        if use_latent_intent:
            ...
            model.add_cpd(latent_intent_cpd)
        ...
        outcome_cpd = TabularCPD(
            ...
            variable_card=2,
            values=np.array([
                [0.95, 0.7, 0.2],  # No manipulation
                [0.05, 0.3, 0.8]   # Manipulation
            ]),
