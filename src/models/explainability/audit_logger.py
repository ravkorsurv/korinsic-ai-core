...
class ModelAuditLogger:
    ...
    def log_model_decision(
        ...
        try:
            ...
            audit_entry = AuditLogEntry(
                ...
                event_data={
                    ...
                    'decision_metadata': {
                        ...
                        'explainability_score': explanation.get('explanation_metadata', {}).get('explanation_quality', 0.0)
                    }
                },
                user_id=user_id,
            ...
            # Check compliance
            compliance_result = self.compliance_checker.check_decision_compliance(decision, explanation)
...
class ComplianceChecker:
    ...
    def _check_explainability_compliance(self, explanation: Dict[str, Any]) -> Dict[str, Any]:
        ...
        explanation_quality = explanation.get('explanation_metadata', {}).get('explanation_quality', 0.0)
        
        passed = (
            has_feature_attributions and 
            has_decision_path and 
            explanation_quality >= self.compliance_rules['minimum_explanation_quality']
        )
    ...
    def _check_risk_documentation_compliance(
        ...
        if is_high_risk:
            has_risk_indicators = len(explanation.get('regulatory_summary', {}).get('risk_indicators', [])) > 0
            has_decision_rationale = explanation.get('regulatory_summary', {}).get('decision_rationale', '') != ''
    ...
    def _generate_compliance_summary(self, audit_entries: List[AuditLogEntry]) -> Dict[str, Any]:
        ...
        for entry in decision_entries:
            ...
            compliance_scores.append(
                explanation.get('explanation_metadata', {}).get('regulatory_compliance', {}).get('compliance_score', 0.0)
            )
...
class RiskDocumenter:
    ...
    def document_high_risk_decision(
        ...
        risk_document = {
            ...
            'decision_rationale': explanation.get('regulatory_summary', {}).get('decision_rationale', ''),
            'regulatory_context': {
