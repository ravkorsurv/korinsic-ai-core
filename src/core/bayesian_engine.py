...
class BayesianEngine:
    ...
    def _create_insider_dealing_model(self):
        ...
        cpd_risk = TabularCPD(
            ...
            values=[
                # Low risk scenarios
                [0.95, 0.9, 0.8, 0.85, 0.7, 0.5, 0.7, 0.5, 0.2,  # MaterialInfo=0
                 0.8, 0.7, 0.5, 0.6, 0.4, 0.2, 0.4, 0.2, 0.1,   # MaterialInfo=1
                 0.5, 0.3, 0.1, 0.3, 0.1, 0.05, 0.2, 0.05, 0.01], # MaterialInfo=2
